    ...
    <div className="min-h-screen bg-gray-50 pb-20 relative">
      ...
      {showFilters && (
        <>
          ...
          {/* Filter Panel */}
          <div
            className={`fixed top-0 right-0 h-full w-80 bg-white z-50 shadow-2xl transform transition-transform duration-300 ease-in-out overflow-y-auto ${
        ...
        <div className="relative px-4 py-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {/* Title */}
              <h1 className="text-lg font-bold text-white">Browse Cars</h1>
            </div>
        ...
        <div className="flex flex-col gap-3">
          {cars.map((car) => (
            <div
              ...
              className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 relative cursor-pointer active:scale-[0.98] transition-transform p-3"
            >
