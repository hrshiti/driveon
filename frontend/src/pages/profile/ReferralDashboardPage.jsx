  ...
  return (
    <div className="min-h-screen pb-24 bg-gray-50">
      ...
      <header className="text-white relative overflow-hidden shadow-md" style={{ backgroundColor: theme.colors.primary }}>
        ...
        <div className="relative px-4 pt-3 pb-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <h1 className="text-lg font-bold text-white">Referral Dashboard</h1>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <h2 className="text-3xl font-bold">{points || totalPointsFromReferrals}</h2>
            </div>
      ...
      <div className="px-4 pt-2 pb-2">
        <div className="bg-white rounded-xl p-4 shadow-md border" style={{ borderColor: theme.colors.borderLight }}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold mb-0.5" style={{ color: theme.colors.textPrimary }}>
                Your Referral Code
              </h3>
          ...
          <div className="flex items-center gap-2 mb-3">
            <div className="flex-1 px-4 py-3 rounded-lg bg-gray-50 border-2 border-dashed" style={{ borderColor: theme.colors.primary }}>
              <p className="text-lg font-bold text-center font-mono" style={{ color: theme.colors.primary }}>
                {displayReferralCode}
              </p>
            </div>
            <button
              onClick={handleCopyReferralCode}
              className="px-4 py-3 rounded-lg font-semibold text-sm transition-all shadow-sm hover:shadow-md flex items-center gap-2"
              style={{
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg font-semibold text-sm transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            style={{
      ...
      <div className="px-4 pt-2 pb-2">
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-white rounded-lg p-3 shadow-sm border text-center" style={{ borderColor: theme.colors.borderLight }}>
            <p className="text-xs mb-1" style={{ color: theme.colors.textSecondary }}>Total</p>
            <p className="text-lg font-bold" style={{ color: theme.colors.primary }}>{totalReferrals}</p>
          </div>
          <div className="bg-white rounded-lg p-3 shadow-sm border text-center" style={{ borderColor: theme.colors.borderLight }}>
            <p className="text-xs mb-1" style={{ color: theme.colors.textSecondary }}>Active</p>
            <p className="text-lg font-bold" style={{ color: theme.colors.success }}>{activeReferrals}</p>
          </div>
          <div className="bg-white rounded-lg p-3 shadow-sm border text-center" style={{ borderColor: theme.colors.borderLight }}>
            <p className="text-xs mb-1" style={{ color: theme.colors.textSecondary }}>Points</p>
            <p className="text-lg font-bold" style={{ color: theme.colors.primary }}>{totalPointsFromReferrals}</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 pt-2 pb-2">
        <div className="bg-white rounded-xl p-4 shadow-md border" style={{ borderColor: theme.colors.borderLight }}>
          <h3 className="text-sm font-semibold mb-3 flex items-center gap-2" style={{ color: theme.colors.primary }}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-2.5 rounded-lg" style={{ backgroundColor: `${theme.colors.primary}08` }}>
              <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold text-white" style={{ backgroundColor: theme.colors.primary }}>
                1
              </div>
              <div className="flex-1">
                <p className="text-xs font-semibold mb-0.5" style={{ color: theme.colors.textPrimary }}>
                  Friend Signs Up
                </p>
                <p className="text-xs" style={{ color: theme.colors.textSecondary }}>
      ...
      <div className="px-4 pt-2 pb-2">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold mb-1" style={{ color: theme.colors.primary }}>
      ...
      <div className="px-4 pt-2 pb-4">
        ...
        {referrals.length === 0 ? (
          <div className="bg-white rounded-xl p-6 text-center shadow-sm border" style={{ borderColor: theme.colors.borderLight }}>
            <svg className="w-12 h-12 mx-auto mb-3" style={{ color: theme.colors.textTertiary }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {referrals.map((referral) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <h4 className="text-sm font-semibold mb-0.5" style={{ color: theme.colors.textPrimary }}>
                      {referral.name}
                    </h4>
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className="text-xs mb-0.5" style={{ color: theme.colors.textSecondary }}>
                      Points Earned
                    </p>
                ...
                <p className="text-xs mt-2 pt-2 border-t" style={{ color: theme.colors.textTertiary, borderColor: theme.colors.borderLight }}>
